...
- Your login: is mfwsuser5@demo.broadcom.com
...
- Your userid is CUST005.
- Your password CUST005.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS05 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS05 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST005.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST005.MARBLES.JCL(MARBCOPY)" --vasc`
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-05.git`
